...
#### res.createStream([payload][, timeout[, code[, seqno]]]): VsoaStream
...
- `code`: *{Number}*, optional RPC reponse code, default 0.
- `seqno`: *{Number}*, optional RPC sequence number, default to the one from `req`.
